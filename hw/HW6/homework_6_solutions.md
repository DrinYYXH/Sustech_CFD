...
$$
\quad u_t = -a u_x \quad u_{tt} = a^2 u_{xx}
$$
...
$$
u_t + a u_x =
\frac{a(\Delta x)^2}{6}(C^2 - 1) u_{xxx}+ \frac{a(\Delta x)^3}{24}C(1 - C^2) u_{xxxx}+ \cdots
$$
...
$$
u_t + a u_x =\frac{a\Delta x}{2}(1 - C) u_{xx}+ \frac{a(\Delta x)^2}{6}(1 - 3C + 2C^2) u_{xxx}+ \cdots
$$
